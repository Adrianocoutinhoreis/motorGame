...
Jogo da Velha, no Jogo da Ordenação, no Encaixe Certo, no Jogo da Memória e no
Material Dourado — reaproveitado aqui de propósito: por não ter fala, o mesmo efeito
serve a qualquer jogo da coleção. Copiado de
`Games/numerandus/jogo-da-memoria/assets/audio/acertoSOS.wav`.
