...
| Duração | **10,76 s** |
| SHA-256 (16 primeiros) | `fa807f4ce477b179` |
| Origem | **A confirmar** — o humano forneceu o arquivo já pronto nesta sessão, sem
  registrar quem gravou/gerou nem a licença. |

## Transcrição

> «Deixe em ordem para completar o tabuleiro. Do menor para o maior (ou do maior para o
> menor, no nível difícil). Quando as 10 fichas estiverem certas, o tabuleiro inteiro
> comemora!»
...
2. o texto acima é exatamente o título + o corpo que a tela exibe
   ...
   (10,76 s para as 31 palavras do texto) dá **2,88 palavras/s**, ritmo de fala pausada
   compatível com locução infantil — e na mesma faixa medida nos outros dois passos
   (2,5 a 3,1 palavras/s), sugerindo um lote gravado de uma vez, no mesmo tom.
