...
| Duração | **7,44 s** |
| SHA-256 (16 primeiros) | `ebbb69e3bfb87ce2` |
| Origem | **A confirmar** — o humano forneceu o arquivo já pronto nesta sessão, sem
  registrar quem gravou/gerou nem a licença. |

## Transcrição

> «Os números estão fora de ordem. O tabuleiro tem 12 casas coloridas: 10 com números
> embaralhados e 2 vazias.»
...
2. o texto acima é exatamente o título + o corpo que a tela exibe
   ...
   (7,44 s para as 19 palavras do texto) dá **2,55 palavras/s**, ritmo de fala pausada
   compatível com locução infantil — e na mesma faixa medida nos outros dois passos
   (2,9 a 3,1 palavras/s), sugerindo um lote gravado de uma vez, no mesmo tom.
