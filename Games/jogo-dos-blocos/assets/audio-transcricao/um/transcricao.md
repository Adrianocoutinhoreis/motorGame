...
| | |
|---|---|
| Arquivo | `assets/audio/um.mp3` |
| `id` no motor | `um` |
| Tipo | Narração — nome de número |
| Formato | MP3 MPEG2 Layer III, 40 kbps, 22 050 Hz, mono |
| Duração | **0,39 s** (15 frames) |
| SHA-256 (16 primeiros) | `723c12cbb71a9785` |
...
1. o nome do arquivo é `um.mp3`;
2. no código da aula original, arraySons['facil'] = ['um','dois','tres','quatro','cinco'];
3. duração de 0,39 s — compatível com uma única palavra curta;
...
Nível 1 ("Números 1 a 5"), 1º bloco da torre (símbolo **1**). Tocado no canal `speech` no instante em que o bloco encaixa.
