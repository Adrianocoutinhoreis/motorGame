...
| | |
|---|---|
| Arquivo | `assets/audio/o.mp3` |
| `id` no motor | `o` |
| Tipo | Narração — som de vogal |
| Formato | MP3 MPEG2 Layer III, 40 kbps, 22 050 Hz, mono |
| Duração | **0,52 s** (20 frames) |
| SHA-256 (16 primeiros) | `ef3eed708d810428` |
...
É o som da letra **O** (o nome da vogal), não uma palavra.
...
1. o nome do arquivo é `o.mp3`;
2. o código da aula original mapeia este id à 4ª vogal: `arraySons['dificil'] = ['a','e','i','o','u']`;
3. duração de 0,52 s — compatível com a emissão de uma vogal;
...
Nível 3 ("Vogais"), 4º bloco da torre (símbolo **O**). Tocado no canal `speech` no instante em que o bloco encaixa.
