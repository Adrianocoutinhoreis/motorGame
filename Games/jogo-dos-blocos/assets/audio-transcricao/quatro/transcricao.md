...
1. o nome do arquivo é `quatro.mp3`;
...
Nível 1 ("Números 1 a 5"), 4º bloco da torre (símbolo **4**). Tocado no canal `speech` no instante em que o bloco encaixa.
